#1.Implimenting a stack using an array
#To impliment a stack we can do with 3 things 1.Array(fixedsize-hectic) 2.ArrayList 3.LinkedList
#o(1) for push pop peak
class Stack:
